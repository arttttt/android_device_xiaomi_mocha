...
/*
 * mocha: upstream declares the two paths it reads its sub-HAL list from here.
 * This copy names its one sub-HAL in get_so_paths() instead -- see the note
 * there -- so the constants would be defined and never read.
 */
